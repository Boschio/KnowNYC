...
import com.example.knownyc.data.local.repository.BoroughsRepositoryImpl
...
//    @Binds
//    @Singleton
//    abstract fun nycParksLocalRepositoryProvider(impl: com.example.knownyc.data.remote.NycParksRepositoryImpl): NycParksRepository
//
//    // API service
//    companion object {
//        @Singleton
